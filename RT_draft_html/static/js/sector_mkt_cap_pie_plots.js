...
d3.json("../data/sector_count.json").then((importedSectorData) => {
    ...
    d3.json("../data/small_cap.json").then((scData) => {
      // console.log(scData);
